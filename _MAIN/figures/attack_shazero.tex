...
%    \fill[pattern=dots] (0,-22.2) -- (7,-18) -- (13,-18) -- (20,-22.2); % NB 1
%	\fill[pattern=dots] (0,-22.4) rectangle (20,-26); % NB 2
%    \fill[pattern=dots] (0,-26.1) rectangle (20,-30); % NB 3
%    \fill[pattern=dots] (0,-30) rectangle (20,-33); % NB 6
    \fill[pattern=dots] (20,-22.2) -- (20,-34) -- (15,-33) -- (10,-34) -- (5,-33) -- (0,-34) -- (0,-22.2) -- (7,-18) -- (13,-18) -- (20,-22.2);
