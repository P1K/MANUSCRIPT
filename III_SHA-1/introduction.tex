...
\begin{defi}[Preimage resistance] Given a target $t$, an adversary must not be able to find a message $m$ such that $\hash(m) = t$ with non-negligible probability using
