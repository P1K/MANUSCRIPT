...
\paragraph{Hash-based signatures.} A less common use of hash functions is to utilise them to directly define signature schemes. We will not describe such schemes in detail
...
%TODO ref HMAC, HMAC attacks?, one poly mac
...
% MD-SHA from MD4 (ARX+Bool, Multiple-branch Feistel)
% SHA-0, SHA-1
% '98 and '05 attacks
% Note that preimage is much harder (e.g. MD4, SHA-1)

\subsection{Contributions of this thesis}


% This work: practical freestart on GPUs
% Another work: preimages on SHA-1
