\begin{tikzpicture}[scale=0.22,>=latex']
    ...
    \node[anchor=text] at (55,-27.5) {Message with};
    \node[anchor=text] at (55,-29) {neutral bits};
    \draw[pattern=crosshatch] (50,-26) rectangle (51.5,-27.5);
    %
    \draw[thick] (50,-30) rectangle (51.5,-31.5);
    \node[anchor=text] at (55,-31.5) {Affected by};
    \node[anchor=text] at (55,-33) {neutral bits};
    \draw[pattern=dots] (50,-30) rectangle (51.5,-31.5);

    %title
    \node[anchor=text] at (0,3) {\shaone State words ($A_i$)};
    \node[anchor=text] at (25,3) {\shaone Message words ($W_i$)};
