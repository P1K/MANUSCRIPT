...
Its high-level structure follows the Merkle-Damg{\aa}rd paradigm~\cite{DBLP:conf/crypto/Damgard89a,DBLP:conf/crypto/Merkle89a}: the input message to the function
