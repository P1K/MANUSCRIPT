...
Let us assume that we have full control over six consecutive expanded message words $\dstate$: $\expmess_{i\ldots i + 5}$ and $\dexpmess_{i\ldots i + 5}$
used in the computation of two related \sha states $\state$, and that we have $\expmess_j = \dexpmess_j$ for $j < i$.
