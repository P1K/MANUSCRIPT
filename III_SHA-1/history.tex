...
All the attacks presented in this section are differential in nature. In its simplest form, the idea such attacks is to find a ``good'' \emph{message difference}\footnote{
