...
\end{tikzpicture}
\end{center}
\caption[tototototototo]{The inter-snippet buffer for steps $\state_{18}$ to $\state_{21}$.
...
\toprule
 & Message 1\\
\midrule
\iv &  \hspace{-1.95mm}\texttt{81 bf 23 06  41 b8 3b \framebox{\color{Cerulean}5c  03} e9 a7 8f  ba 50 28 d5  fc 50 87 88} \\
\midrule
...
\midrule
$\compress(\iv,\mess)$ & \texttt{af 49 5d 10  52 82 35 03  e4 9e 46 78  dc e7 f3 b3  d6 da a3 24} \\
\bottomrule\\

\toprule
 & Message 2 \\
\midrule
$\diff$\iv & \hspace{-1.95mm}\texttt{81 bf 23 06  41 b8 3b \framebox{\color{RubineRed}5d  83} e9 a7 8f  ba 50 28 d5  fc 50 87 88}\\
\midrule
...
\midrule
$\compress(\diff\iv,\diff\mess)$ & \texttt{af 49 5d 10  52 82 35 03  e4 9e 46 78  dc e7 f3 b3  d6 da a3 24}\\
\bottomrule
\end{tabular}
\end{table}
