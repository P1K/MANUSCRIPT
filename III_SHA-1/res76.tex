...
as \begin{tikzpicture}[scale=0.67,transform shape]\draw[fill=Rhodamine!30] (0,0) circle (.3) node{15};\end{tikzpicture}. Although not including such non-neutral bits would save some space, it would make the storing process
