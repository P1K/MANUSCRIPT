...
\title{
Practical freestart collision attacks on \textswab{SHA-1}\thanks{This article presents two recent papers on practical freestart collision attacks on \shaone in a unified and expanded way:
