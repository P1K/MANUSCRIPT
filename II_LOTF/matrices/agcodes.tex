...
has differential and linear branch number at least 15 (in fact exactly 15). This code is also self-dual,
...
This code can be used to define a diffusion matrix of dimension 32 over $\Fst$, which diffuses over $32\times 4 = 128$ bits and
has differential and linear branch number at least 27 (in fact exactly 27). This code is also self-dual,
which implies in particular that its derived diffusion matrices are orthogonal.
\end{example}
